  ...
  .controller('DreiCtrl', function ($scope, autocompleteService, $timeout, $http) {
    ...
    this.cveEmpfehlungsArray = [];
      ...
      ermoeglicht : {
        ...
        text : "<b>MISKONFIGURATION</b>: Der Angriff erfolgte über eine Schwachstelle, die auf einen Konfigurationsfehler zurückzuführen ist.<br><br><b>USB GERÄTE</b>: Schädliche Software wurde über ein USB Medium infiltriert.<br><br><b>E-MAIL</b>: Schädliche Software wurde über E-Mail infilitriert.<br><br><b>UNZUREICHENDE EINGABEVALIDIERUNG</b>: Inputfelder werden nicht ausreichend validiert, sodass schädlicher Code infilitriert werden konnte.<br><br><b>BOTNETZ</b>: Ein großer Zusammenschluss von mit Malware infizierten PCs ermöglichte den Angriff.<br><br><b>IDENTITÄTSDIEBSTAHL</b>: Der Angriff wurde dadurch ermöglicht, dass sich der Angreifer eine vertrauenswürdige Identität verschafft hat.<br><br><b>IT-SICHERHEITSLÜCKE</b>: Der Angriff wurde durch einen Design- oder Implementationsfehler eines IT-Produktes ermöglicht.<br><br><b>SOCIAL ENGINEERING</b>: Der Angriff wurde dadurch ermöglicht, dass Personen zu sicherheitskritischen Handlungen gedrängt wurden."
      },
      art : {
        title : "Art des Angriffs",
        text : "<b>SCHADPROGRAMM</b>: Schädlicher Code wurde infiltriert und wird auf dem betroffenen System ausgeführt.<br><br><b>DENIAL-OF-SERVICE</b>: (D)DoS ist in der Regel die Folge einer Überbelastung eines Dienstes mithilfe eines Botnetzs.<br><br><b>BELIEBIGE CODEAUSFÜHRUNG</b>: Der Angreifer hat sich auf eine Weise Zugang verschafft, welche ihn berechtigt beliebigen Code auf dem betroffenen System auszuführen."
      },
      zweck : {
        title : "Intention",
